...
class AppNB:
    ...
    def generate_all(self, outdir=os.path.join(os.getcwd(), '.generated/'), dockerurl="undefined"):
        ...
        generated_files = []
        generated_files.append(self.generate_workflow_cwl(outdir=outdir))
        generated_files.append(self.generate_cache_cwl(outdir=outdir))
        generated_files.append(self.generate_stage_in_cwl(outdir=outdir))
        generated_files.append(self.generate_process_cwl(dockerurl, outdir=outdir))
        generated_files.append(self.generate_stage_out_cwl(outdir=outdir))
        generated_files.append(self.generate_descriptor(dockerurl, outdir=outdir))

        return generated_files

    def generate_workflow_cwl(self, outdir=os.path.join(os.getcwd(), '.generated/')):
    ...
    def generate_cache_cwl(self, outdir=os.path.join(os.getcwd(), '.generated/')):
    ...
    def generate_stage_in_cwl(self, outdir=os.path.join(os.getcwd(), '.generated/')):
    ...
    def generate_process_cwl(self, dockerurl, outdir=os.path.join(os.getcwd(), '.generated/')):
    ...
    def generate_stage_out_cwl(self, outdir=os.path.join(os.getcwd(), '.generated/')):
        """Generates the stage-in CWL.
    ...
    def generate_descriptor(self, dockerurl, outdir=os.path.join(os.getcwd(), '.generated/')):
